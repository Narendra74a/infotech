...
const Services = () => {
  ...
  return (
    <>
      ...
      <span class="flex mt-32 drop-shadow-xl justify-center text-2xl/7  font-bold  text-gray-900 sm:truncate sm:text-3xl sm:tracking-tight">
        Services
      </span>
        <div className="grid grid-cols-1  sm:grid-cols-2   py-10 px-24 lg:grid-cols-3 gap-6">
          {cardsData.map((card) => (
            <div
              key={card.id}
